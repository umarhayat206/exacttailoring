...
if($_POST['ftName']!=""){ //Save measurements
	...
	$fType->ftDescription = $_POST['ftDescription'];
	$fType->ftImagepath = smImages::Upload($_FILES['ftImage']['name'],$_FILES['ftImage']['tmp_name']);
	...
	for($i=0;$i<=$countTo;$i++){
		...
		?>
			<fieldset>
				...
				<?php smImages::showThumb($fabrics[$i]->fImage,$fabrics->ftName,160);?>
