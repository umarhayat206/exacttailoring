...
class smControls{
	...
	public static function smCheckBox($label="sm Check Box", $id="", $value="", $checked=false, $futherAttributes=""){
		if($checked!=false And $checked!="N" And $checked!="No" And $checked!="NO" And $checked!="" And $checked!="false"){
	...
	public static function smDropDownList($label="sm Drop Down List", $id="", $itemArray=array("key"=>"value"), $valueToSelect="" , $furtherAttributes="", $suppressLabel=false, $addSelectOption=false){
		...
		echo("<select id='".$id."' name='".$id."' ".$furtherAttributes." >");
