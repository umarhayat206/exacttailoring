...
<tr>
<td width="100%" bgcolor="{$table_top}">&nbsp;<b><font color="{$section_head_txt}">{$commissionstats_title}</font></b></td>
</tr>
<tr>
<td width="100%" bgcolor="{$lighter_cells}" colspan="2" align="center">
<table border="0" cellpadding="0" cellspacing="0" width="98%">
<tr>
<td width="100%"><br />{$commissionstats_info}</td>
</tr>
</table>
...
<BR />
  ...
  <table border="0" cellspacing="1" width="95%">
    <tr>
      <td width="100%" colspan=3>&nbsp;<b>{$commissionstats_hint}</b></td>
    </tr>
    <tr>
      <td width="25%" bgcolor="{$white_back}">&nbsp;{$commissionstats_profile}:</td>
      <td width="35%" bgcolor="{$white_back}">&nbsp;<input type="text" size="20" value="{$sitename}"></td>
      <td width="40%" bgcolor="{$white_back}" rowspan="4" align="center"><img border="0" src="images/cs_1.gif" width="148" height="59"></td>
    </tr>
    <tr>
      <td width="25%" bgcolor="{$white_back}">&nbsp;{$commissionstats_username}:</td>
      <td width="35%" bgcolor="{$white_back}">&nbsp;<input type="text" size="20" value="{$username}"></td>
    </tr>
    <tr height="25">
      <td width="25%" bgcolor="{$white_back}">&nbsp;{$commissionstats_password}:</td>
      <td width="35%" bgcolor="{$white_back}">&nbsp;<font color="#707070">[{$account_hidden}]</font></td>
    </tr>
    <tr>
      <td width="25%" bgcolor="{$white_back}">&nbsp;{$commissionstats_id}:</td>
      <td width="35%" bgcolor="{$white_back}">&nbsp;<input type="text" size="20" value="{$link_id}"></td>
    </tr>
    <tr>
      <td width="25%" bgcolor="{$white_back}">&nbsp;{$commissionstats_source}:</td>
