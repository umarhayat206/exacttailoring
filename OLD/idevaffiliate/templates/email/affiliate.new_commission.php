...
$e=$indv_data['email'];
// ------------------------------------------------
$edata=mysql_query("select new_app_subject, new_app_body from idevaff_email");
...
if ($email == 'top') {
$amt = "Commission Amount: $cur_sym$payout $currency";
} elseif ($email == 'tier') {
$amt = "Tier Commission Amount: $cur_sym$payout $currency"; }
// ------------------------------------------------
