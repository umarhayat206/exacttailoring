...
$adata=mysql_query("select id, tier, username, password, f_name, l_name, email from idevaff_affiliates where id = '$af'");
...
$edata=mysql_query("select admin_rec_subject, admin_rec_body from idevaff_email");
...
if ($tier != 0) {
$adata=mysql_query("select username from idevaff_affiliates where id = '$tier'");
$indv_data=mysql_fetch_array($adata);
$tier=$indv_data['username'];
} else {
$tier = "None"; }
