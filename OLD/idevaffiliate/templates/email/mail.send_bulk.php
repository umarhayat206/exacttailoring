...
if ($_POST['choice'] == "all") {
$get_user=mysql_query("select id, username, password, email, f_name, l_name from idevaff_affiliates");
} else {
$get_user=mysql_query("select id, username, password, email, f_name, l_name from idevaff_affiliates where approved = $who"); }

if (mysql_num_rows($get_user)) {
while ($get_details = mysql_fetch_array($get_user)) {
