...
'automatically added' => 'läggs till automatiskt',
 'importintro' => '<p class="information">Filen som du laddar upp behöver inte ha postattributen på den första raden.
    ...
    <br/>',
'uploadlimits' => 'Följande gränser har satts av din server:<br/>
Maximal total datastorlek sänd till server: <b>%s</b><br/>
Maximal storlek för varje individuell fil: <b>%s</b>',
'testoutput_blurb' => 'Om du kryssar för "Testutmatning" kommer du få en lista över analyserade e-postadresser på skärmen och databasen kommer inte fyllas på med informationen. Detta är användbart för att se om din fil är korrekt formaterad. Endast de första 50 posterna kommer visas.',
'warnings_blurb' => 'Om du kryssar för "Visa varningar" kommer du varnas för ogiltiga poster. Varningar kommer endast visas om du kryssar för "Testutmatning". De kommer ignoreras när den faktiska importen sker. ',
'omitinvalid_blurb' => 'Om du kryssar för "Försumma ogiltiga" kommer ogiltiga poster inte läggas till. Ogiltiga poster är poster utan e-postadress. Alla andra attribut kommer läggas till automatiskt, så om t. ex. en posts land inte kan hittas kommer den läggas til i listan över länder.',
'assigninvalid_blurb' => 'Ogiltighetstilldelning kommer användas för att skapa en e-postadress för medlemmar med ogiltig e-postadress.
...
'overwriteexisting_blurb' => 'Om du kryssar för "Skriv över befintliga" kommer information om en medlem i databasen ersättas med den importerade informationen. Medlemmar matchas genom e-postadress eller främmande nycklar.',
'retainold_blurb' => 'Om du kryssar för "Behåll gammal medlemsepostadress" kommer den gamla adressen behållas vid en konflikt mellan två e-postadresser och "dubblett" läggas till den nya adressen. Om du inte kryssar för det kommer den gamla kallas "dubblett" och den nya kommer få företräde.',
'sendnotification_blurb' => 'Om du väljer "sänd notifieringsmeddelande" kommer medlemmarna du lägger till få en bekräftelsebegäran för anmälan som de måste svara på. Detta rekommenderas då det kommer identifiera ogiltiga e-postadresser.',
'phplist Import  Results' => 'phplist-importresultat',
...
## added 2008-05-12
'phplistuploadlimit' => '<br/>PHPlist kommer inte bearbeta filer större än %dMB',
