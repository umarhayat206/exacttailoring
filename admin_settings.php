...
<script type="text/javascript">
	$(document).ready(function(){
		$('.tinymce').tinymce({
			...
			theme_advanced_buttons1 : "bold,italic,underline,|,justifyleft,justifycenter,justifyright,fontsizeselect,bullist,|,removeformat",
			theme_advanced_buttons2 : "link,unlink,image,forecolor,|,code,fullscreen",
...
include('forms/admin_category.php');
include('forms/admin_feature.php'); 
include('forms/admin_fabric.php');
include('forms/admin_pattern.php');
include('forms/admin_color.php');
