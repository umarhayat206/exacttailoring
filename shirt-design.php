<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#f-37, #f-155, #f-286").change(function() { // Cuffs change men=f-31 | women=f-155
			if ($("#f-37").val() == "40" || $("#f-155").val() == "177" || $("#f-286").val() == "306") {
				$("#shirtCuffs").css({
					"background": "url('images_shirt/cuffs_single_button.gif')"
				});
			} else if ($("#f-37").val() == "38" || $("#f-155").val() == "178" || $("#f-286").val() == "307") {
				$("#shirtCuffs").css({
			...
			} else if ($("#f-37").val() == "39" || $("#f-155").val() == "179" || $("#f-286").val() == "308") {
				$("#shirtCuffs").css({
					"background": "url('images_shirt/cuffs_convertable.gif')"
				});
			} else if ($("#f-37").val() == "42" || $("#f-155").val() == "180" || $("#f-286").val() == "309") {
				$("#shirtCuffs").css({
					"background": "url('images_shirt/cuffs_french.gif')"
				});
			} else if ($("#f-37").val() == "133" || $("#f-155").val() == "181" || $("#f-286").val() == "310") {
				$("#shirtCuffs").css({
					"background": "url('images_shirt/cuffs_french_rounded.gif')"
				});
			} else if ($("#f-37").val() == "41" || $("#f-155").val() == "176" || $("#f-286").val() == "311") {
				$("#shirtCuffs").css({
		...
		*/
		...
		$("#f-43, #f-158, #f-287").change(function() { // Fastening change men=f-43 | women=f-158
			...
			} else if ($("#f-43").val() == "44" || $("#f-158").val() == "190" || $("#f-287").val() == "314") { // Plackett
				$("#shirtButtons").css({
					"background": "url('images_shirt/buttons.gif')"
				});
				$("#shirtPlackets").css({
...
<div id="shirtView">
	<div id="shirtBody" style="background-image: url(images_shirt/body_normal.gif); background-position: initial initial; background-repeat: initial initial;">
