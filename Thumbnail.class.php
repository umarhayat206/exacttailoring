...
class Thumbnail {
    ...
    **/
    function unique_filename ( $archive_dir , $filename , $file_prefix='') {
    	...
    	$destination = $file_prefix."".$name.".".$extension;
    	...
    	while (file_exists($archive_dir."/".$destination)) {
    		...
    		$destination = $file_prefix."".$name."".rand(0,999999999).".".$extension;
    	}
