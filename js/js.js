...
/* show or hide gadgets */
  $('a[rel="hide_block"]').click(function(){
	if ($(this).parent('div').parent('div').children('div.gadgetblock').css('height')=='auto') $(this).css('background-image','url(styles/images/button_dropup_bl.gif)');
	else $(this).css('background-image','url(styles/images/button_dropdown_bl.gif)');
...
/* show or hide error-message */
  $('a[rel="hide_err"]').click(function(){
	...
	if ($(this).parent('div').parent('div').children('div.error_msg').css('height')=='auto') $(this).css('background-image','url(styles/images/button_dropup'+color+'.gif)');
	else $(this).css('background-image','url(styles/images/button_dropdown'+color+'.gif)');
