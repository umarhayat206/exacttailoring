...
if(empty($_SESSION['chkmemberuser'])){ // member not login 
    ...
    if(!empty($_POST['applyCoupon']) && !empty($_POST['inputDiscount'])){
        ...
        if(!empty($checkCouponCode->promotionId)){           
                ...
                if(!empty($shoppingitems)){
                    foreach($shoppingitems as $item){
                        ...
                        <tr>
                            ...
                            <td class="quantity">
                                    <input type="text" name="<?php echo $itemQty; ?>" id="<?php echo $itemQty; ?>" value="<?php echo $item->itemQty; ?>" />
                            </td>
    ...
    <div class="span7">
        <div id="cart-tab">
            ...
            <ul class="nav nav-tabs">
                <li class="">
                    <a href="#dis-code" data-toggle="tab">Apply Discount Code</a>
                </li><!--
                <li class="active">
                ...
                <div class="tab-pane active" id="dis-code">
                    <form method="post" id="applyCouponForm" name="applyCouponForm" action="<?=_URL_; ?>shoppingcart" class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="inputDiscount" name="inputDiscount" placeholder="Enter Discount Code...">
                            </div>
                        </div>
            ...
            <div class="cart-receipt">
                <table class="table table-receipt">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan="2">
                                <label class="btn" onclick="window.location='<?=_URL_; ?>collection'">Contuine Shoping</label>
                            </td>
                        </tr>
                    </tbody>
                </table>
